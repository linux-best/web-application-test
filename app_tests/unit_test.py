...
def test_login():
    assert login_test_section(login_user="admin",login_passwd="password") == "login passed !"

def test_CSRF():
    assert CSRF_Test_section(old_password="password",new_paassword="123") == "Password Changed !"
